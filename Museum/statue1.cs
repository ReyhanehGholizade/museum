...
namespace Museum
{
    public partial class statue1 : Form
    {
        public statue1()
        {
            InitializeComponent();
        ...
        private void statue1_Load(object sender, EventArgs e)
        {
        ...
        private void درج_Click(object sender, EventArgs e)
        {
            ...
            {
                c1.ExecuteNonQuery();
                c1.CommandText = "insert into StatueORScupture values(N'" + textBox1.Text + "',N'" + textBox2.Text + "', N'" + textBox3.Text + "', N'" + textBox4.Text + "')";
                c1.Connection = con1;
                try
                {
                    c1.ExecuteNonQuery();
        ...
        private void ویرایش_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand c1 = new SqlCommand();
            c1.CommandText = "update StatueORScupture set Material= N'" + textBox1.Text + "', Height = N'" + textBox2.Text + "', SWeight = N'" + textBox3.Text + "' where Id_No= '" + textBox4.Text + "'";
            c1.Connection = con1;
        ...
        private void textBox7_TextChanged(object sender, EventArgs e)
        {
            ...
            con1.ConnectionString = "server=DESKTOP-3TBI42A;database=Museum1;integrated security=true";
            con1.Open();
            SqlDataAdapter da = new SqlDataAdapter("select * from StatueORScupture where Material like '" + textBox7.Text + "%'", con1);
            DataTable dt = new DataTable();
            da.Fill(dt);
            dataGridView1.DataSource = dt.DefaultView;
