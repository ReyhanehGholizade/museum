...
namespace Museum
{
    public partial class other1 : Form
    {
        ...
        private void other1_Load(object sender, EventArgs e)
        {
        ...
        private void درج_Click(object sender, EventArgs e)
        {
            ...
            {
                c1.ExecuteNonQuery();
                c1.CommandText = "insert into Other values(N'" + textBox1.Text + "',N'" + textBox2.Text + "', N'" + textBox3.Text + "')";
                c1.Connection = con1;
                try
                {
                    c1.ExecuteNonQuery();
        ...
        private void ویرایش_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand c1 = new SqlCommand();
            c1.CommandText = "update Other set OType= N'" + textBox1.Text + "', Style = N'" + textBox2.Text + "' where Id_No= '" + textBox3.Text + "'";
            c1.Connection = con1;
        ...
        private void textBox7_TextChanged(object sender, EventArgs e)
        {
            ...
            con1.ConnectionString = "server=DESKTOP-3TBI42A;database=Museum1;integrated security=true";
            con1.Open();
            SqlDataAdapter da = new SqlDataAdapter("select * from Other where OType like '" + textBox7.Text + "%'", con1);
            DataTable dt = new DataTable();
            da.Fill(dt);
            dataGridView1.DataSource = dt.DefaultView;
